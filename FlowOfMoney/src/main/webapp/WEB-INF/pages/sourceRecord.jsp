   				...
   				$.each(response, function(key, value) { //populate child options
   					...
   					var eachrow = "<tr>"
   						+ "<td><input type='checkbox' /> </td>"
   		                 + "<td>" + value.Sr_Id+"</td>"
   		                 + "<td>" + value.Sr_Date + "</td>"
   		                 + "<td class='more'>" + value.Sr_Name + "</td>"
   		                 + "<td>" + value.Sr_Deposits + "</td>"
   		              	+ "<td>" + value.Sr_Balance + "</td>"
   		           		+ "<td class='more'>" + value.Sr_Description + "</td>"
   		                 + "</tr>";
   		              
   					$("#sourceRecord").append(eachrow);
      ...
      <tr>
        <td>         
          <div class="headTableFloat">
              	...
              	<div><button class="GrayBtn GrayBtn-primary" onclick="return SelectMailDynamic('Direct', 'SourceRecord');">Send email</button></div>
              	<div><button class="GrayBtn GrayBtn-primary" onclick="return commonPOPUpTwoDates('SourceRecord');">Excel</button></div>
          </div>          
        </td>
      </tr>
      <tr>
        <td>
            <table border="1" id="example" class="display table table-striped table-bordered"  cellspacing="0" width="100%">
              ...
              <tr>
                ...
                <th style="border-right-style: hidden;">Deposits</th>
                <th style="border-right-style: hidden;">Balance</th>
                <th style="border-right-style: hidden;">Dr_Description</th>
                </tr>
              </thead>
              <tfoot>
    			<tr><th></th> <th></th> <th></th> <th>total: </th> <th></th> <th></th> <th></th></tr>
    			</tfoot>
              <tbody id="sourceRecord">
